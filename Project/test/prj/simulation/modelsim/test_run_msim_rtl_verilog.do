...
vlog -vlog01compat -work work +incdir+C:/Users/X1\ Carbon/Documents/Quartus/test/rtl {C:/Users/X1 Carbon/Documents/Quartus/test/rtl/test.v}
...
vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver -L rtl_work -L work -voptargs="+acc"  test_vlg_tst
